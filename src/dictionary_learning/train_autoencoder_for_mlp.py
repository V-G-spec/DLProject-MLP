...
def main():
    f = h5py.File("/home/fmassari/scaling_mlps/acts_B_12-Wi_1024_cifar10_test_postskip.h5", "r")
    for key in f.keys():
        print(key) 
    ...
    for epoch in range(epochs):
        ...
        if (epoch+1)%10==0:
            torch.save(sparse_autoencoder.state_dict(), 'SAE_100_epochs_bs_32_CIFAR10_test_B_12-Wi_1024_postskip_l1_3e-2.pt')
